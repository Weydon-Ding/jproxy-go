...
func createProxyFormatterDatabase(t *testing.T) string {
	...
	statements := []string{
		...
		`CREATE TABLE radarr_title (tmdb_id INTEGER DEFAULT 0, sno INTEGER DEFAULT 0, main_title TEXT, title TEXT, clean_title TEXT, year INTEGER, monitored INTEGER DEFAULT 1, valid_status INTEGER)`,
		`CREATE TABLE sonarr_title (tvdb_id INTEGER DEFAULT 0, sno INTEGER DEFAULT 0, main_title TEXT, title TEXT, clean_title TEXT, season_number INTEGER, monitored INTEGER DEFAULT 1, valid_status INTEGER)`,
